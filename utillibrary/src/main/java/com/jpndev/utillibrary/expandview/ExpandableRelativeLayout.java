package com.jpndev.utillibrary.expandview;
...
import com.jpndev.utillibrary.R;
...
public class ExpandableRelativeLayout extends RelativeLayout implements com.jpndev.utillibrary.expandview.ExpandableLayout {
    ...
    private com.jpndev.utillibrary.expandview.ExpandableLayoutListener listener;
    private com.jpndev.utillibrary.expandview.ExpandableSavedState savedState;
    ...
    private void init(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        ...
        final int interpolatorType = a.getInteger(R.styleable.expandableLayout_ael_interpolator,
                com.jpndev.utillibrary.expandview.Utils.LINEAR_INTERPOLATOR);
        a.recycle();
        interpolator = com.jpndev.utillibrary.expandview.Utils.createInterpolator(interpolatorType);
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        final com.jpndev.utillibrary.expandview.ExpandableSavedState ss = new com.jpndev.utillibrary.expandview.ExpandableSavedState(parcelable);
    ...
    protected void onRestoreInstanceState(final Parcelable state) {
        if (!(state instanceof com.jpndev.utillibrary.expandview.ExpandableSavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        final com.jpndev.utillibrary.expandview.ExpandableSavedState ss = (com.jpndev.utillibrary.expandview.ExpandableSavedState) state;
     ...
     */
    @Override
    public void setListener(@NonNull com.jpndev.utillibrary.expandview.ExpandableLayoutListener listener) {
